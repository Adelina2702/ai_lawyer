  ...
  return (
    <div className={styles.tab}>
      ...
      <div className={styles.tab__header}>
        ...
        <p className={styles.tab__header_name}>Asan</p>
      </div>
      ...
      <div>
        <span className='text-[#D4D4D4] pl-[10px] text-[18px] '>
          За последний месяц
        </span>
        <div className='mt-[15px]'>
          <div className=' pl-[10px] absolute'>
            <Chat2 />
          </div>
          <div className='flex pl-[50px] text-[#fff] mb-[20px] text-[17px]'>
          ...
          <div className='mt-[15px]'>
            ...
            <div className='flex ml-[50px] text-[#fff] mb-[20px] text-[17px]'>
            ...
            <div className='mt-[15px]'>
              ...
              <div className='pl-[50px] flex text-[#fff] mb-[20px] text-[17px] text-whiteounded-lg '>
